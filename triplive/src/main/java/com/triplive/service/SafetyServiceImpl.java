...
public class SafetyServiceImpl implements SafetyService{
        ...
        @Transactional
        public List<GetCountrySafetyList2> getSafetyList(Integer pageNum, String keyword) {
        ...
        @Transactional
        public Long getSafetyListCount() {
        ...
        public Integer[] getPageList(Integer curPageNum, String keyword) {
                ...
                // 총 게시글 갯수
                Double postsTotalCount = Double.valueOf(this.getSafetyListCount());
