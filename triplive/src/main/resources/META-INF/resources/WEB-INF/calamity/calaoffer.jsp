...
<html lang="ko">
<head>
<title>TRIPLIVE COVID19 OFFER</title>
<meta charset="utf-8">
					...
					<div class="row fill_height no-margin">
						<div class="col fill_height no-padding">
							...
							<div class="search_panel active">
								<form action="/calamity/calamity.do?isoNum=" id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
							...
							<div class="search_panel">
								<form action="/calamity/calamity.do?keyword=" id="search_form_2" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
									<div class="search_item">
										<div>검색어 입력</div>
